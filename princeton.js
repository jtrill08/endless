    ...
    fetch(`https://data.artmuseum.princeton.edu/objects/${randomObjectId}/tombstone`)
        ...
        .then(data => {
            ...
            if (data.primaryimage) {
                ...
                console.log('Retrying fetch for object ID:', randomObjectId);
                fetchRandomObject();
            }
        })
        .catch(error => {
...
princetonTab.addEventListener('scroll', () => {
    ...
    // Check if the user has scrolled to 80% from the bottom of the Princeton tab content
    if (scrollPercentage >= 80) {
        // Load more artworks for Princeton
